...
from .serializers import LNMOnlineSerializer, C2BPaymentsSerializer
...
class MakeLNMPayment(ModelViewSet):
    ...
    #     phonenumber = self.kwargs.get('phone_number')
...
def make_payment(request,phone_no,amount):
    payment = lipa_na_mpesa(phone_no, amount)
    print(payment)
